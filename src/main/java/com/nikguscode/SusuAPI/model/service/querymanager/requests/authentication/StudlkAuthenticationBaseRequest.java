...
@Service
@RequestScope
public class StudlkAuthenticationBaseRequest extends AuthenticationBaseRequest implements AuthenticationRequestSender {
    private final CsrfTokenExtractor csrfExtractor;

    public StudlkAuthenticationBaseRequest(Configurator configurator,
